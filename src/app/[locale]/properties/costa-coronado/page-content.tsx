"use client";
// Costa Coronado — UNOBRA oceanfront vertical development in Playas de Tijuana.
...
const MAPS_URL              = "https://www.google.com/maps/place/Playas+de+Tijuana,+Tijuana,+B.C.";
...
export default function CostaCoronadoPageContent() {
  const t = useTranslations("propertyCostaCoronado");
          ...
          <div className="mx-auto max-w-336.5 rounded-15 bg-[#7cd4b2] px-8 py-10 lg:px-16 lg:py-12">
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="relative mx-auto aspect-1792/2400 w-44 shrink-0 overflow-hidden rounded-3 lg:w-52">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={IMG_LOT_RENDER} alt={t("models.renderAlt")} className="absolute inset-0 h-full w-full object-cover" />
              </div>
            </div>
          </div>
