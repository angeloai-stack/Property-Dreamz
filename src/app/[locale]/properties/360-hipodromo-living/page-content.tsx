"use client";
// 360 Hipódromo Living — UNOBRA urban vertical development in Zona Hipódromo, Tijuana.
// No dedicated design/photography exists yet; structure and imagery follow the
// pattern of the other fraccionamiento pages (The Wavve, Costa Real) as a placeholder.
// Page is currently hidden (see page.tsx) — this component is kept for when it's re-enabled.
...
const IMG_AMENITY_POOL   = "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=800&q=80";
const IMG_AMENITY_LOUNGE = "https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?w=800&q=80";
const IMG_AMENITY_GYM    = "https://images.unsplash.com/photo-1504109586057-7a2ae83d1338?w=800&q=80";
const IMG_MODEL_RENDER   = "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&q=80";
const IMG_CMRE           = `${CLD}/CMRE_Logo-04_yjsknz.png`;
const IMG_DEVELOPER_LOGO = `${CLD}/unobra/developer-logo`;
const MAPS_EMBED_URL     = "https://www.google.com/maps?q=32.5117,-117.0130&z=13&output=embed";
const MAPS_URL           = "https://www.google.com/maps/place/Zona+Hip%C3%B3dromo,+Tijuana,+B.C.";
...
export default function HipodromoLiving360PageContent() {
  ...
  const monthlyPaymentDisplay = monthlyPayment === null ? "—" : `$ ${monthlyPayment.toLocaleString("en-US")} USD`;
  ...
  return (
    <div className="overflow-x-hidden bg-[#111318] text-white">

      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative min-h-205 overflow-hidden bg-[#111318]">
        ...
        <div className="absolute inset-0 bg-[#1a2440]/40 mix-blend-multiply" />

        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to top, #111318 8%, transparent 45%)" }}
        />
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col items-end gap-4 lg:flex-row lg:items-center lg:gap-6">
              ...
              <RevealOnScroll direction="right" delay={100}>
                <button
                  type="button"
                  className="rounded-3.75 bg-brand-teal px-8 py-3.5 font-ewangi text-[1.1rem] font-bold text-[#111318] transition hover:bg-brand-teal/90"
                >
      ...
      <section className="px-6 py-8 lg:px-20 lg:py-10">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
          {[
            ...
            { src: IMG_AMENITY_LOUNGE, alt: t("amenities.loungeAlt") },
            { src: IMG_AMENITY_GYM, alt: t("amenities.gymAlt") },
          ].map((amenity, i) => (
          ...
          <div className="mx-auto max-w-336.5 rounded-15 bg-[#7cd4b2] px-8 py-10 lg:px-16 lg:py-12">
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              <div className="lg:w-80 shrink-0">
                ...
                <p className="font-ewangi text-[clamp(1.75rem,3vw,2.25rem)] text-[#111318] mb-6">{currentLayout.area}</p>
              ...
              <div className="flex flex-col items-start gap-4 lg:w-56 shrink-0">
                <div>
                  ...
                  <p className="font-ewangi text-[1.7rem] font-bold text-[#111318]">
                    {currentLayout.price}{" "}
                    <span className="font-ewangi text-base font-normal text-[#111318]">{currentLayout.priceCurrency}</span>
                  </p>
                  <p className="font-ewangi text-[0.95rem] text-[#111318]/70">{currentLayout.priceSecondary}</p>
                </div>
                <button
                  type="button"
                  className="rounded-1.25 bg-[#111318] px-6 py-2.5 font-ewangi text-[0.95rem] text-white transition hover:bg-[#111318]/85"
                >
              ...
              <div className="relative mx-auto aspect-1792/2400 w-44 shrink-0 overflow-hidden rounded-3 lg:w-52">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={IMG_MODEL_RENDER} alt={t("models.renderAlt")} className="absolute inset-0 h-full w-full object-cover" />
              </div>
            </div>
          </div>
        ...
        <RevealOnScroll direction="up" delay={100} duration={1000}>
          <div className="rounded-6 border border-white/25 p-8 lg:p-12">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
              <div>
                <span className="inline-block rounded-md bg-[#111318] px-4 py-1.5 font-ewangi text-sm text-white">
            ...
            <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="w-fit rounded-4.25 bg-brand-teal px-14 py-5 font-ewangi text-2xl font-bold text-[#111318] transition hover:bg-brand-teal/90"
              >
      ...
      <section className="bg-white px-6 py-16 lg:px-20 lg:py-20">
        <RevealOnScroll direction="up" duration={1000}>
          <div className={cn(
            "mx-auto flex max-w-7xl flex-col gap-6 rounded-3.75 bg-[#111318] px-8 py-10",
