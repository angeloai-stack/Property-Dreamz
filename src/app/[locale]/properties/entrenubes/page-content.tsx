"use client";
// Entrenubes — Grupo INOVI high-rise condo tower in Hipódromo, Tijuana.
...
const MAPS_URL              = "https://www.google.com/maps/place/Hip%C3%B3dromo,+Tijuana,+B.C.";
...
export default function EntrenubesPageContent() {
  ...
  const [propertyPrice, setPropertyPrice] = useState(165000);
          ...
          <div className="mx-auto max-w-336.5 rounded-15 bg-[#7cd4b2] px-8 py-10 lg:px-16 lg:py-12">
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="relative mx-auto aspect-1792/2400 w-44 shrink-0 overflow-hidden rounded-3 lg:w-52">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={IMG_UNIT_RENDER} alt={t("models.renderAlt")} className="absolute inset-0 h-full w-full object-cover" />
              </div>
            </div>
          </div>
        ...
        <RevealOnScroll direction="up" duration={1000}>
          <div className="rounded-5.5 border border-white/30 p-8 lg:p-12">
            <div className="flex flex-col gap-6 lg:flex-row-reverse lg:items-start lg:gap-10">
              {/* No dedicated Grupo INOVI logo asset uploaded yet — wordmark badge stands in until one is provided. */}
              <div
                role="img"
                aria-label={t("developer.logoAlt")}
                className="flex h-14 w-36 shrink-0 items-center justify-center rounded-lg bg-white p-2.5 lg:h-16 lg:w-40"
              >
                <span className="font-ewangi text-[0.95rem] font-bold tracking-wide text-[#000f2c] lg:text-base">GRUPO INOVI</span>
              </div>
              <div>
