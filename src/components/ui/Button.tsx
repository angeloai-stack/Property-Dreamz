...
export function Button({ href, className, variant = "default", ...props }: ButtonProps) {
  const base = "inline-flex items-center justify-center rounded-[var(--radius-btn)] px-[var(--space-5)] py-[var(--space-3)] font-ibrand text-subtitle font-semibold transition duration-200 focus:outline-none disabled:pointer-events-none disabled:bg-brand-paper/70 disabled:text-brand-gray disabled:shadow-none";
