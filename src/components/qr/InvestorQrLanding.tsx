"use client";
// QR-only landing page for investors — same Linktree-style structure as DeveloperQrLanding,
// reusing the Roll-Up-01 banner photo as hero and swapping in the investor form/links.
import Image from "next/image";
import { useTranslations } from "next-intl";
import { FaFacebookF, FaInstagram } from "react-icons/fa6";
import { BookOpen, Globe } from "lucide-react";
import { Link } from "@/i18n/navigation";
import { InvestorQuickForm } from "@/components/qr/InvestorQuickForm";
...
export function InvestorQrLanding() {
  const t = useTranslations("investorLinks");
    ...
    <main className="min-h-screen bg-brand-paper">
      ...
      <div className="relative mx-auto -mt-14 flex max-w-md flex-col items-center px-6 pb-16 text-center">
        ...
        <div className="mt-6 flex w-full flex-col gap-3">
          ...
          <LinkButton href="/buyers-guide" icon={BookOpen}>
            {t("links.buyersGuide")}
          </LinkButton>
        </div>
